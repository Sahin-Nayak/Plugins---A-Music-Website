    ...
    <div>
            ...
            <div className="hidden lg:flex justify-between items-center gap-4">
                <div className="flex text-[15px] gap-5 text-yellow-400 font-semibold">
                    <Link to="/signup"><li className="list-none bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded-full transition duration-300">Sign Up / Log In</li></Link>
